# D_EJC
D_EJC (Disc Ejector) Ejects Disc from your prefered drive with a single click  
...
例えば、取り出したいディスクの入っている対象のドライブのドライブレターが"F:"の場合、ソフト名は"F_EJC.exe"とします。  
以上です!　これでアイコンをクリックするだけでディスクを取り出せます!  
